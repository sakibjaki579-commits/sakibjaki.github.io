...
2. Getting information from NHS/local health organisations.

3. Showing pharmacy locations to the user.

4. Creating a basic mobile app to display the information.
