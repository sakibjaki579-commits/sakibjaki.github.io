...
### Problem statement
The problem is about medicine shortage and variations in availability along with different prices across Health Establishments. Patients are finding it difficult to find spesific medicines that are in stock or is too expensive. This leads to delays in treatments and pressure on healthcare services. There is currently no type of app/tool that lets people check certian medical services or what medicine are provided by health services. 
...
![Insert your Context Diagram Here](https://github.com/sakibjaki579-commits/sakibjaki.github.io/blob/main/docs/images/canvas%20(1).png)
